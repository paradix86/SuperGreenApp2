...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'towelieHelperAddDevice': MessageLookupByLibrary.simpleMessage('**Power the controller** with its supply if it is not on yet, then choose above how to reach it: a **new controller** broadcasts its own Wi-Fi, an **existing one** is already on your home network.'),
    'towelieHelperAddExistingDevice': MessageLookupByLibrary.simpleMessage('Your controller is already on your **home Wi-Fi**, so let\'s find it on the network.\nType the **name you gave it** (default **supergreencontroller**) or its **IP address**. The IP is listed on your router\'s page: take your phone\'s IP, replace the last number with **1** and open it in a browser.'),
    'towelieHelperCreateLab': MessageLookupByLibrary.simpleMessage('A **lab** is the space your plant grows in: a tent, a box or a shelf with its own **lights and ventilation**.\nGive it a name; you can link a controller to it right after.'),
    'towelieHelperCreatePlant': MessageLookupByLibrary.simpleMessage('Welcome! I\'ll guide you through creating your first plant.\nStart by **giving it a name**: the strain, a nickname, anything you\'ll recognise.'),
    'towelieHelperDeviceWifi': MessageLookupByLibrary.simpleMessage('Connecting the controller to your **home Wi-Fi** is optional but useful:\n- firmware **updates**\n- **monitoring** from anywhere\n- **remote control** with an SGL account'),
    'towelieHelperFormMeasure': MessageLookupByLibrary.simpleMessage('The **measuring tool** is not lab-accurate, but it gives you a **good reference for the next grow** and builds a **timelapse** from all your measures.'),
    'towelieHelperFormMeasure2': MessageLookupByLibrary.simpleMessage('This is your **first measure**, so there is no earlier picture to compare to. Photograph what you want to measure and come back in **a few days** to see the difference.'),
    'towelieHelperFormMeasure3': MessageLookupByLibrary.simpleMessage('You already have a measure: pick it under **Previous measures**, then tap **Today\'s measure**. The old picture shows as a **transparent overlay** so you can line them up.'),
    'towelieHelperFormTakePic': MessageLookupByLibrary.simpleMessage('Take a picture of your plant and **note what you see**. Regular photos are the best diary you\'ll have during the next grow.'),
    'towelieHelperMeasureAfterStretch': MessageLookupByLibrary.simpleMessage('Good moment to **take a measure** and keep an eye on the **stretch**.'),
    'towelieHelperMeasureReminder': MessageLookupByLibrary.simpleMessage('Want me to **set a reminder** so you don\'t forget the next measure?'),
    'towelieHelperSelectDevice': MessageLookupByLibrary.simpleMessage('Now that the plant has a name, let\'s set it up.\nIf you own a **SuperGreenLab controller**, choose which one will drive this plant\'s **lights, ventilation and sensors**. Brand new? Start with **New controller**.\nNo controller? Tap **NO SGL DEVICE** to skip this step.'),
    'towelieHelperSelectNewPlantDeviceBox': MessageLookupByLibrary.simpleMessage('Choose which of the controller\'s **LED channels** light this plant. Keep the panels **plugged in** so you can see which one reacts.'),
    'towelieHelperSelectPlantDeviceBox': MessageLookupByLibrary.simpleMessage('A controller manages up to **3 boxes**. Pick a box that is **already set up** above, or create a **new one**.'),
    'towelieHelperTestDevice': MessageLookupByLibrary.simpleMessage('Quick check that everything responds. **Plug the LED panels into the controller** if you haven\'t yet, then run the test.'),
    'towelieHelperWaterReminder': MessageLookupByLibrary.simpleMessage('Want me to **set a reminder** for the next watering?'),
