...
void main() {
  ...
  test('records only box sensor readings, oldest first', () {
    ...
    DashHistory.record(1, dash({'BOX_0_TEMP': 28, 'BOX_0_ON_HOUR': 10, 'LED_0_DIM': 100}), at: t0);
  ...
  test('drops readings older than maxAge and honours the requested window', () {
    ...
    DashHistory.record(1, dash({'BOX_0_HUMI': 55}), at: t0.add(const Duration(hours: 2)));
    DashHistory.record(1, dash({'BOX_0_HUMI': 60}), at: t0.add(const Duration(hours: 4)));
